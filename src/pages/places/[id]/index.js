      ...
      <div className="mt-28 w-full">
        <div className="mx-auto" style={{ width: "80%" }}>
          <div className="mx-auto ">
            <span className="text-2xl font-bold flex">
              ...
              <div className="flex flex-row justify-between w-full">
                <span className="capitalize-first">{place.title}</span>{" "}
                  ...
                  <span className="grid grid-cols-2 gap-2 text-sm">
                    <button
                      onClick={() => {
                        ...
                        PlaceService.deletePlace(place._id, token).then(
                          (success) => {
                            router.push("/");
                          }
                        );
                    ...
                    <button onClick={() => router.push("update/" + place._id)}>
                      Update
                    </button>
                  </span>
                )}
            ...
            <div className="flex flex-row justify-between">
              <div className="flex mt-2">
                ...
                <span className="ml-2 font-semibold underline cursor-pointer">
                  {" "}
                  Tremosine sul Garda, Brescia, Italie
                </span>
              </div>
              <div className="flex">
                <span className="mx-4 flex cursor-pointer">
                  {" "}
                  <ShareOutline /> Partager
                </span>
                <span className="mx-4 flex cursor-pointer">
                  {" "}
                  <HeartOutline /> Enregistrer
                </span>
              </div>
            </div>
          </div>
          <div className="mx-auto mt-4 flex">
            <img
              className="object-cover block w-1/2  rounded-xl p-1"
              src={place.images}
              alt={place.title}
              style={{ height: "400px" }}
            />
            <div className="grid grid-cols-2 w-1/2">
              <img
                className="object-cover  block w-full  rounded-xl p-1"
                src={place.images}
                alt={place.title}
                style={{ height: "200px" }}
              />
            ...
            <div style={{ width: "60%" }}>
              <div className="mt-6 flex justify-between border-b-2 pb-8">
                <div className="flex flex-col">
                  ...
                  <span>
                    {" "}
                    {place.capacity && place.capacity} voyageurs · 1 chambre · 2
                    lits · 1 salle de bain
                  </span>
                </div>
              </div>
              ...
              <div className="border-b-2 pb-6 mt-8">
                <div className="flex flex-col my-4">
                  <span className="text-lg font-semibold flex">
                    {" "}
                    <HeartOutline className="mr-2 " />{" "}
                    <span className="capitalize-first">
                      {place.owner.firstName} est Superhôte
                    </span>
                  </span>
                  <span className="ml-8">
                    Les Superhôtes sont des hôtes expérimentés qui bénéficient
                    de très bonnes évaluations et qui s'engagent à offrir
                    d'excellents séjours aux voyageurs.
                  </span>
                </div>
                <div className="flex flex-col my-4">
                  <span className="text-lg font-semibold flex">
                    {" "}
                    <LocationMarkerOutline className="mr-2" /> Idéalement situé
                  </span>
                  <span className="ml-8">
                    95 % des voyageurs ont attribué 5 étoiles à l'emplacement du
                    logement.
                  </span>
                </div>
                <div className="flex flex-col my-4">
                  <span className="text-lg font-semibold flex">
                    {" "}
                    <CalendarOutline className="mr-2" /> Annulation gratuite
                    avant le 31 janv..
                  </span>
                </div>
              </div>
              ...
              <div className="aircover mt-6 border-b-2 pb-8">
                ...
                <p className="mt-4">
                  ...
                  d'annulation par l'hôte, d'inexactitudes dans la description
                  du logement, ainsi que d'autres problèmes comme les
                  difficultés d'accès au logement.
                </p>
                <span className="cursor-pointer mt-6 underline font-semibold">
                  En savoir plus...
                </span>
              </div>
              <div className="mt-4">
              ...
              <div className="border  shadow-2xl w-5/6 rounded-xl p-6">
                <div className="flex justify-between">
                  ...
                  <div className="flex">
                    ...
                    <span className="underline ml-2 opacity-80 cursor-pointer">
                      {" "}
                      64 Commentaires
                    </span>
                  </div>
                ...
                <div className="rounded-xl w-full mt-6" ref={ref}>
                  ...
                  <div className="grid grid-cols-2 mx-auto">
                    <div
                      className="uppercase border rounded-tl-xl p-2 flex flex-col cursor-pointer"
                    ...
                    <div
                      className="uppercase border rounded-tr-xl p-2 flex flex-col cursor-pointer"
                      onClick={() => setSelect(!select)}
                    >
                ...
                <button
                  className="mt-4 w-full rounded-md h-12 reservation"
                ...
                <div className="opacity-90 text-center mt-2">
                ...
                <div className="w-full border-b-2 pb-4">
                  <div className="flex justify-between py-2 cursor-pointer">
                    ...
                    <span className="underline">
                      {" "}
                      {place.pricePerDay} € x {dates.nbNights} nuits
                    </span>{" "}
                    <span>
                      {place.pricePerDay * dates.nbNights > 0 &&
                        place.pricePerDay * dates.nbNights}{" "}
                      €
                    </span>{" "}
                  </div>
                  <div className="flex justify-between py-2 cursor-pointer">
                ...
                <div className="flex justify-between mt-3">
                  ...
                  <span>
                    {" "}
                    {place.pricePerDay * dates.nbNights > 0 &&
                      place.pricePerDay * dates.nbNights + 122}{" "}
                    €
                  </span>{" "}
                </div>
              </div>
