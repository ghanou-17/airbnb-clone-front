...
const Index = () => {
  ...
  async function fetchData() {
    try {
      ...
      const response = await placesService.getPlace(router.query.id); //jwt
      setPlace({
        _id: response.data._id,
        title: response.data.title,
        types: response.data.types._id,
        owner: response.data.owner,
        pricePerDay: response.data.pricing.perDay,
        ...
        address: {
          ...
          street: {
            ...
            gps: {
              ...
              long: response.data.address.long,
            },
          },
        },
      });
    ...
    <div className="w-full">
      ...
      <div className="mt-32 xl:w-1/2 md:w-3/4 sm:w-3/4 sm:mt-40 mx-auto">
        <form
          ...
          className="mx-auto mt-24 p-3 mb-8 border-slate-500 border rounded-md"
        >
          <div className="mb-4 text-center ">
            <label
              className="block text-secondary font-bold text-xl mb-2"
              htmlFor="title"
            >
              Titre
            </label>
          ...
          <div className="mb-4 text-center">
            <label
              className="block text-secondary font-bold mb-2 text-left"
              htmlFor="type"
            >
              Type
            </label>
          ...
          <div className="mb-4 grid grid-cols-2 gap-2 justify-evenly">
            <div>
              <label
                className="block text-secondary italic font-semibold mb-2 w-full"
                htmlFor="pricePerDay"
              >
                Prix / jour
              </label>
              <input
                ...
                max={9999}
                onChange={(e) =>
                  setPlace({ ...place, pricePerDay: e.target.value })
                }
            ...
            <div className="w-full">
              <label
                className="block font-semibold w-full text-secondary italic mb-2"
                htmlFor="capcity"
              >
                Nombre de personnes
              </label>
              <input
                ...
                id="capacity"
                onChange={(e) =>
                  setPlace({ ...place, capacity: e.target.value })
                }
          ...
          <div className="mb-4 w-full">
            <label
              className="block text-secondary w-full font-medium mb-2"
              htmlFor="description"
            >
              Description
            </label>
          ...
          <div className="mb-4 mt-4 flex justify-center text-center">
            <div className="mr-2">
              ...
              <input
                ...
                onChange={(e) =>
                  setPlace({
                    ...place,
                    address: { ...place.address, city: e.target.value },
                  })
                }
            ...
            <div className="ml-2">
              <label
                className="block italic font-medium mb-2"
                htmlFor="zipCode"
              >
                Zip Code
              </label>
          ...
          <div className="w-40 mx-auto text-center">
            <button
              ...
              className="bg-slate-500 hover:shadow-xl hover:scale-105 transition-all text-white font-medium py-2 px-4 rounded-full"
            >
              Update
            </button>
          </div>
